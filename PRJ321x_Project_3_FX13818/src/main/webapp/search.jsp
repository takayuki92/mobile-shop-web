	...
	<section id="products" class="bg-light align-items-center">
		...
		<div class="container my-3 p-3">
			<ul class="pagination pagination-lg justify-content-center">
				<li class="page-item"><a class="page-link" href="SearchController2?index=${param.index -1}&txtSearch=${txtSearch}"><i class="bi bi-arrow-left"></i></a></li>
				<c:forEach begin="1" end="${endP}" var="i">
					<li class="page-item"><a class="page-link" href="SearchController2?index=${i}&txtSearch=${txtSearch}">${i}</a></li>
				</c:forEach> 
				<li class="page-item"><a class="page-link" href="SearchController2?index=${param.index +1}&txtSearch=${txtSearch}"><i class="bi bi-arrow-right"></i></a></li>				
			</ul>
		</div>
	</section>
